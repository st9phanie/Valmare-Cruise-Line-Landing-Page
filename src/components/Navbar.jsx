export const Navbar = () => {
    ...
    return (
        <div>
            <header className="w-full bg-black flex text-white sticky top-0 z-12">
                ...
                <div className="lg:px-32 px-6 py-4 w-full">
                    ...
                    <nav className="flex items-center justify-between relative w-full">
                        ...
                        <ul className="flex gap-x-12  tracking-[0.8px] montserrat-regular items-center">
                            ...
                            <li className="font-semibold text-[13px] flex flex-row gap-x-1/2 items-center hover:underline">
