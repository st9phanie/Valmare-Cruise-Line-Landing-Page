...
export const Destinations = () => {
    ...
    return (
        <section id="#destinations" className="bg-[#f8f4f0] montserrat-regular">
            <div className="px-8 lg:px-32 lg:py-16 montserrat-regular">
                <div className="flex flex-col lg:flex-row items-center">
                    <h1 className="text-4xl didot tracking-[0.5px] text-center lg:py-6 py-10">WORLDWIDE DESTINATIONS</h1>
                    <div className="flex flex-col lg:items-start gap-2">
                        <p className="">Truly immersing yourself in your destination requires a brand-new experience. Our tailored itineraries allow you to go deeper</p>
                        ...
                        {slides.map((slide, idx) => (
                            <SwiperSlide key={idx}>
                                ...
                                <div className=" py-6 text-center">
                                    <h3 className="text-lg lg:text-3xl tracking-[1px]">{slide.title}</h3>
                                    <p className="pt-4 didot text-sm lg:text-baseline text-gray-800 px-4">{slide.desc}</p>
                                </div>
                            </SwiperSlide>
                        ))}
                    </Swiper>
